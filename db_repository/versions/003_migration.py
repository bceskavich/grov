...
def upgrade(migrate_engine):
    ...
    pre_meta.tables['user'].columns['twitter_id'].drop()
    post_meta.tables['user'].columns['twitter'].create()
...
def downgrade(migrate_engine):
    ...
    pre_meta.bind = migrate_engine
    post_meta.bind = migrate_engine
    pre_meta.tables['user'].columns['twitter_id'].create()
    post_meta.tables['user'].columns['twitter'].drop()
